                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="crt_header" class="form-control" name="crt_header"
                                            placeholder="Enter course Name..."
                                            value="{{ old('crt_header', $course->crt_header) }}">
                                        @error('crt_header')
                                            <span class="invalid-feedback text-danger" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="crt_title" class="form-control" name="crt_title"
                                            placeholder="Enter course crt title..."
                                            value="{{ old('crt_title', $course->crt_title) }}">
                                        @error('crt_title')
                                            <span class="invalid-feedback text-danger" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="crt_footer" class="form-control" name="crt_footer"
                                            placeholder="Enter course Name..."
                                            value="{{ old('crt_footer', $course->crt_footer) }}">
                                        @error('crt_footer')
                                            <span class="invalid-feedback text-danger" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" id="course_end_date" type="date" name="course_end_date"
                                            value="{{ old('course_end_date', $course->course_end_date) }}">
